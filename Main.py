...
def main_account_screen():
    ...
    main_screen.title("Cloth Defect Detection  ")
    Label(text="Cloth Defect Detection", width="300", height="5", bg='pink', font=("Calibri", 16)).pack()
    Button(text="UploadImage", font=(
        'Verdana', 15), height="2", width="30", command=training, highlightcolor="black",bg='red').pack(side=TOP)
    Label(text="").pack()
    Button(text="Training", font=(
        'Verdana', 15), height="2", width="30", command=fulltraining, highlightcolor="black",bg='red').pack(side=TOP)
    Label(text="").pack()
    Button(text="Testing", font=(
        'Verdana', 15), height="2", width="30",bg='red', command=testing).pack(side=TOP)
    Label(text="").pack()
